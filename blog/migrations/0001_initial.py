# Generated by Django 4.0 on 2022-03-01 15:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.TextField(blank=True, max_length=250, null=True, verbose_name='محتوا')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', tinymce.models.HTMLField(blank=True, null=True, verbose_name='محتوا')),
                ('thumbnail', models.ImageField(upload_to='images', verbose_name='تصویر بند انگشتی')),
                ('published', models.DateTimeField(default=django.utils.timezone.now, verbose_name='زمان انتشار')),
                ('created', models.DateTimeField(auto_now=True)),
                ('updated', models.DateTimeField(auto_now_add=True)),
                ('status', models.CharField(choices=[('P', 'Published'), ('D', 'Draft')], max_length=1, verbose_name='وضعیت نمایش')),
                ('topics', models.ManyToManyField(related_name='articles', to='blog.Topics', verbose_name='تاپیک')),
            ],
            options={
                'verbose_name': 'مقاله',
